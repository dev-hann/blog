...
| `--bg-hover` | 호버 상태 | `#1e1e1e` |

### 1.2 텍스트

| 토큰 | 용도 | 값 |
|---|---|---|
| `--text-primary` | 본문 텍스트 | `#d4d4d8` |
| `--text-secondary` | 보조 텍스트 (날짜, 요약) | `#a1a1aa` |
| `--text-muted` | 흐린 텍스트 | `#8a8a93` |
| `--text-accent` | 강조 텍스트, 링크 | `#4ade80` |

### 1.3 브랜드 / 액센트

| 토큰 | 용도 | 값 |
|---|---|---|
| `--accent` | 메인 액센트 | `#22c55e` (green-500) |
| `--accent-hover` | 액센트 호버 | `#16a34a` (green-600) |
...
| 토큰 | 용도 | 값 |
|---|---|---|
| `--prompt` | 터미널 프롬프트 | `#4ade80` |
| `--comment` | 터미널 주석 | `#6b7280` |
| `--warning` | 콜아웃 경고 | `#fbbf24` |
| `--error` | 콜아웃 오류 | `#ef4444` |
| `--info` | 콜아웃 정보 | `#60a5fa` |
| `--highlight-bg` | 코드 라인 하이라이트 배경 | `rgba(255, 255, 255, 0.08)` |
